...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repos = React.createClass({
		...
		render: function render() {
			...
			repos = this.props.repos.map(function (NYTData, index) {
				return React.createElement(
					"div",
					null,
					React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getRepos(username) {
		return axios.get("https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=" + "&q=" + username);
	};
	...
	*/
	...
	var helpers = {
		getGithubInfo: function getGithubInfo(username) {
			...
			return axios.all([getRepos(username)]).then(function (arr) {
				return {
